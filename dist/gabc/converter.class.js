...
var conversionData_1 = require("../generic/conversionData");
var find_other_clef = function (clef_position, position_of_ps, octave, monodi_alphabet, gregorio_alphabet) {
    ...
    var position_in_greg_bc = getPositionInGABCAlphabet(position_of_ps, octave, monodi_alphabet, best_clef);
    return { clef_change: true, clef: best_clef, char: gregorio_alphabet[position_in_greg_bc] };
};
var getPositionInGABCAlphabet = function (position_input_alphabet, octave, input_alphabet, clef_position) {
...
var GABC = (function () {
    function GABC() {
        ...
        this.file_extension = ".gabc";
    }
    GABC.prototype.createHeader = function (name, gabcCopyright, scoreCopyright, officePart, occasion, meter, commentary, arranger, author, date, manuscript, manuscriptReference, manuscriptStoragePlace, book, language, transcriber, transcriptionDate, mode, userNotes, annotation) {
    ...
    GABC.prototype.transformNote = function (pitch_symbol, octave, clef_position) {
        if (clef_position === void 0) { clef_position = this.currentClef; }
        var position_of_ps = conversionData_1.monodi_alphabet.indexOf(pitch_symbol);
        var position_in_greg = getPositionInGABCAlphabet(position_of_ps, octave, conversionData_1.monodi_alphabet, clef_position);
        return { clef_change: false, clef: clef_position, char: conversionData_1.gregorio_alphabet[position_in_greg] };
    };
    GABC.prototype.transformSyllable = function (syllable) {
        var _this = this;
        var _a, _b, _c;
        ...
        var notation = (_a = syllable === null || syllable === void 0 ? void 0 : syllable.notes) === null || _a === void 0 ? void 0 : _a.spaced.map(function (spaced) {
            ...
            return __spreadArray(["/"], (_a = spaced === null || spaced === void 0 ? void 0 : spaced.nonSpaced) === null || _a === void 0 ? void 0 : _a.map(function (nonspaced) {
                ...
                return __spreadArray(["!"], (_a = nonspaced === null || nonspaced === void 0 ? void 0 : nonspaced.grouped) === null || _a === void 0 ? void 0 : _a.map(function (grouped) {
                    return _this.transformNote(grouped === null || grouped === void 0 ? void 0 : grouped.base.toLowerCase(), grouped === null || grouped === void 0 ? void 0 : grouped.octave);
                }), true);
            }), true);
        });
    ...
    Object.defineProperty(GABC.prototype, "data", {
        get: function () {
            return this._data;
        },
        enumerable: false,
    ...
    GABC.prototype.transformWrite = function (data) {
        var _this = this;
        var _a;
        ...
        var l = lines.reduce(function (out, lineContent) {
            ...
            return __spreadArray(__spreadArray([], out, true), [lineContent['children'].reduce(function (out2, syl) {
                    return __spreadArray(__spreadArray([], out2, true), [_this.transformSyllable(syl)], false);
                }, [])], false);
        }, []);
        var clefPref = "(c3)\n";
        try {
    ...
    GABC.prototype.transformRead = function (data) {
        return data;
    };
    return GABC;
}());
exports["default"] = GABC;
